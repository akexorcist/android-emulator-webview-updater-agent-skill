...
A [Claude Code](https://claude.com/claude-code) agent skill that updates the system WebView on an old Android emulator (AVD) whose built-in version is too outdated to render modern sites — common on API 21-28 images.
